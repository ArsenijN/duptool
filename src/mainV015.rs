...
// Note for anyone who will use that version of code: I very lazy to restore original V015, so this version is actually a V016. Devlog keep changes of true V015, so I'll not change it.